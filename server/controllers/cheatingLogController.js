...
const CheatingLog = require("../models/cheatingLogModel.js");

// @desc Save cheating log data
// @route POST /api/cheatingLogs
// @access Private
exports.saveCheatingLog = asyncHandler(async (req, res) => {
  const {
    noFaceCount,
    multipleFaceCount,
    cellPhoneCount,
...
// @access Private
exports.getCheatingLogsByExamId = asyncHandler(async (req, res) => {
