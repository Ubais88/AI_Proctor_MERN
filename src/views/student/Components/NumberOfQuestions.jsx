    ...
    <>
      ...
      >
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Typography variant="h6">Questions: {cQuestions+1}/{totalQuestions}</Typography>
              ...
              <Stack direction="row" alignItems="center" justifyContent="start">
                {row.map((questionNumber) => {
                  ...
                  if (questionNumber < cQuestions+1) {
                    backgroundColor = 'green'; // Change background color if less than 3
                  } else if (questionNumber === cQuestions+1) {
                    backgroundColor = 'red'; // Change background color if equal to 3
                  } else {
                    backgroundColor = '#ccc'; // Change background color if greater than 3
                  }
                  return (
                    <Avatar
                      key={questionNumber}
